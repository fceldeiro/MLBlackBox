#
#  Be sure to run `pod spec lint MLBlackBox.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/fceldeiro/MLBlackBox.git", :tag => "0.0.1" }
  ...
  s.source_files  = "Classes", "MLBlackBox/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "MLBlackBox/**/*.h"
